...
class Volume:
    ...
    def __init__(self, shapeType, name, material=None, mother=None, position=None,repeater = None):
...
class Cylinder(Volume):
    ...
    def getDiameter(self):
        return max(self.Rmax, self.Height)


class Sphere(Volume):
    def __init__(self, name,  mother=None, position=None, material=None,
                 Rmax=None, Rmin=None, PhiStart=None, DeltaPhi=None, ThetaStart=None, DeltaTheta=None):
