...
def Predifined_OpticalSystem():
    ...
    pixel = Box('pixel', Vec3(3.0, 3.0, 1.0), position=Vec3(
        0, 0, -0.5), material='G4_SILICON_DIOXIDE', mother=crystal, repeater=rcp)
